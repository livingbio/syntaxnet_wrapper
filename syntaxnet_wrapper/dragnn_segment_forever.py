...
def post_seg(processed_sentence):
    segmented_sents = []
...
if __name__ == '__main__':
    ...
    component_beam_sizes = [('char_lstm', '4'), ('lookahead', '4'),
                            ('tagger', '8'), ('parser', '8')]

    master_spec = spec_pb2.MasterSpec()
    with gfile.FastGFile(segmenter_master_spec) as fin:
        text_format.Parse(fin.read(), master_spec)
    spec_builder.complete_master_spec(master_spec, None, segmenter_resource_dir)
